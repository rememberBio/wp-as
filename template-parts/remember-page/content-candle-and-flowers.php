            ...
            <form action="<?php echo $url ?>?tab=candle-and-flowers&cf_post=true" id="cfform" method="POST" <?php if($success_payment) echo "style='display:none;'"; ?> >
                ...
                <div class="step-1" <?php if($payment_error != "") echo "style='display:none;'"; ?>>
                    ...
                    <div class="wrap-error" style="display:none;">
                        <span class="error">There is empty field or field with invalid value</span>
                    </div>
                    ...
                    <div class="wrap-form-fields">
                        <input <?php if( $payment_error != "" && isset($_POST["senderEmail"])) { echo 'value="' . $_POST["senderEmail"] . '"'; } ?> required type="email" placeholder="Email" id="senderEmail" name="senderEmail" >
                        <input <?php if( $payment_error != "" && isset($_POST["senderPhone"])) { echo 'value="' . $_POST["senderPhone"] . '"'; } ?> required type="tel"placeholder="Phone" id="senderPhone" name="senderPhone">
                    </div>
                    <textarea  maxlength="30" name="senderMessage" id="senderMessage" cols="30" rows="10" aria-required="true" placeholder="Message To Family Or Dead"><?php if( $payment_error != "" && isset($_POST["senderMessage"])) { echo $_POST["senderMessage"]; } ?></textarea>
                ...
                <div class="step-2" <?php if($payment_error == "") echo "style='display:none;'"; ?>>
                    ...
                    <div class="wrap-field checkbox">
                        ...
                        <label for="credit_info_card">I Confirm Saving Credit Information</label>
                    </div>
                    <div class="wrap-field checkbox">
                        ...
                        <label for="get_emails">I Confirm Receipt Of Reminder Updates On This Remembrance Day</label>
                    </div>
